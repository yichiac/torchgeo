...
conf_file_name = "ssl4eo_benchmark_oli_tirs_toa_cdl.yaml"
...
loss_options = ["ce"]
wd_options = [0, 0.1]
weight_options = ["/projects/dali/data/pretrained_weights/ssl4eo-l-oli-tirs-toa-mocov2-resnet18/torchgeo.datamodules.ssl4eollmdbdatamodule_torchgeo.trainers.mocotask/ssl4eo-l-oli-tirs-toa-mocov2-resnet18_backbone.ckpt"]
...
if __name__ == "__main__":
    ...
    for model, backbone, lr, loss, wd, weights in itertools.product(
        ...
        experiment_name = f"{conf_file_name.split('.')[0]}_{model}_{backbone}_{lr}_{loss}_{wd}_moco"
