...
loss_options = ["ce"]
weight_options = ["/projects/dali/data/pretrained_weights/ssl4eo-l-etm-toa-simclr-resnet18/torchgeo.datamodules.ssl4eollmdbdatamodule_torchgeo.trainers.simclrtask/ssl4eo-l-etm-toa-simclr-resnet18_backbone.ckpt"]
...
if __name__ == "__main__":
    ...
    for model, backbone, lr, loss, weights in itertools.product(
        ...
        experiment_name = f"{conf_file_name.split('.')[0]}_{model}_{backbone}_{lr}_{loss}_simclr"
