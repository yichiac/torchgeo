...
lr_options = [0.001]
loss_options = ["ce"]
weight_options = ["/projects/dali/data/pretrained_weights/ssl4eo-l-oli-tirs-toa-mocov2-resnet50/torchgeo.datamodules.ssl4eollmdbdatamodule_torchgeo.trainers.mocotask/ssl4eo-l-oli-tirs-toa-mocov2-resnet50_backbone.ckpt"]
seed_options = [0, 1, 2]
