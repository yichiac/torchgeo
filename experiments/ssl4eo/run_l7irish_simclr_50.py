...
loss_options = ["ce"]
weight_options = ["/projects/dali/data/pretrained_weights/ssl4eo-l-etm-toa-simclr-resnet50/torchgeo.datamodules.ssl4eollmdbdatamodule_torchgeo.trainers.simclrtask/ssl4eo-l-etm-toa-simclr-resnet50_backbone.ckpt"]
