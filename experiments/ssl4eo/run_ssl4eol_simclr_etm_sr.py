...
loss_options = ["ce"]
wd_options = [0, 0.1]
weight_options = ["/projects/dali/data/pretrained_weights/ssl4eo-l-etm-sr-simclr-resnet18/torchgeo.datamodules.ssl4eollmdbdatamodule_torchgeo.trainers.simclrtask/ssl4eo-l-etm-sr-simclr-resnet18_backbone.ckpt"]
