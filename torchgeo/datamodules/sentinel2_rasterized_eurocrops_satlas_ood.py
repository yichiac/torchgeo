...
class Sentinel2RasterizedEuroCropsSatlasDataModuleOOD(GeoDataModule):
    ...
    def setup(self, stage: str) -> None:
        ...
        self.train_val_dataset = self.sentinel2 & (self.nccm|self.cdl|self.agrifieldnet|self.south_africa_crop_type|self.south_america_soybean)
