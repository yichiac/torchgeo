...
class SouthAfricaCropTypeMaskSatlasDataModuleOOD(GeoDataModule):
    ...
    def setup(self, stage: str) -> None:
        ...
        self.train_val_dataset = self.sentinel2 & (self.nccm|self.eurocrops|self.agrifieldnet|self.cdl|self.south_america_soybean)
